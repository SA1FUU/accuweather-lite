    ...
    return (
        <div className='social-icons'>
            <div className="parent">
                <a className="child child-3" href='https://github.com/SA1FUU' target='_blank'>
                ...
                <a className="child child-1" href='https://x.com/Khansaif_18' target='_blank'>
                ...
                <a className="child child-2" href='https://www.instagram.com/khansaif_18/' target='_blank'>
